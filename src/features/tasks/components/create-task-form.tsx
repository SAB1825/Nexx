...
export const CreateTaskForm = ({ onCancel, projectOptions, memberOptions }: CreateWorkspaceFormProps) => {
  ...
  return (
    <Card className="w-full max-w-md mx-auto border-none rounded-xl shadow-2xl bg-gradient-to-br from-zinc-900 to-black">
      <CardHeader className="p-8 border-b border-zinc-800">
        <CardTitle className="text-3xl font-bold text-white">Create a new Task</CardTitle>
